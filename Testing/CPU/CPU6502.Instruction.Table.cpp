...
void CPU6502::InitializeInstructionTable() {
    ...
    _instructions[0x0A] = { "ASL", &CPU6502::ASL, &CPU6502::IMP, AddrMode::IMP, 2 }; // AddrMode::ACC
    ...
    _instructions[0x2A] = { "ROL", &CPU6502::ROL, &CPU6502::IMP, AddrMode::IMP, 2 }; // AddrMode::ACC
    ...
    _instructions[0x4A] = { "LSR", &CPU6502::LSR, &CPU6502::IMP, AddrMode::IMP, 2 }; // AddrMode::ACC
    ...
    _instructions[0x6A] = { "ROR", &CPU6502::ROR, &CPU6502::IMP, AddrMode::IMP, 2 }; // AddrMode::ACC
