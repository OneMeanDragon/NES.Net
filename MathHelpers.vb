...
Module MathHelpers
    ...
    Public Function SafeDecrement16(ByVal bytIn As UInt16) As UInt16
        If bytIn = 0 Then
            Return CUShort(&HFFFFUI)
        Else
            Return CUShort(bytIn - 1)
        End If
    End Function
    ...
    Public Function SafeAddition8(ByVal v1 As UInt32, ByVal v2 As UInt32) As Byte
        M32Helper = v1 + v2
        Return CByte(M32Helper And &HFFUI)
    End Function
